...
const styles = {
  ...
  articleContentWrapper: `flex items-center justify-between cursor-pointer my-[1.5rem]`,
          ...
          {recommendedPosts.map(post => (
            <div className={styles.articleContentWrapper}>
              ...
              <div className={styles.recommendationThumbnailContainer}>
                <Image className={styles.recommendationThumbnail} src={post.image} height={100} width={100} />
              </div>
            </div>
...
const recommendedPosts = [
  {
    title: 'What can you do with Replit? Everything About The Best IDE',
    image: ReplitLogo,
    author: {
      name: 'Test Coder',
      image: CPLogo,
  ...
  {
    title: 'The Ultimate JS Course With Industry Relevant Projects',
    image: JSLogo,
    author: {
      name: 'Kumar Ayush',
      image: ReplitLogo,
  ...
  {
    title: 'The 2023 Developer Guide: All The Ideas At One Place',
    image: ReplitLogo,
    author: {
      name: 'Test Coder',
      image: CPLogo,
