...
const styles = {
  wrapper: `flex flex-col justify-center items-center gap-[1rem] p-[1rem] font-mediumSerif overflow-auto`,
...
const PostModal = () => {
  ...
  <div className={styles.smallField}> 
    ...
    <button onClick={addPostToFirebase} className={styles.accentedButton}><Link href="/ " passhref>Submit</Link></button>
